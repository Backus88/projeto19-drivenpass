...
import {createCard ,checkUniqueCards, getCards, canDelete, getCardsId,deleteCardsById,checkCardNumberUnique} from '../services/cardServices';
...
export async function createCards(req:Request, res:Response){
    ...
    await checkCardNumberUnique(card.cardNumber);
